...
hists = [
    ...
    Hist1D("vbs_jet1_eta", r"VBS Jet 1 $\eta$", (NUM_BINS, -5.0, 5.0), scale=SIGNAL_SCALE),
    Hist1D("vbs_jet1_phi", r"VBS Jet 1 $\phi$", (NUM_BINS, -3.5, 3.5), scale=SIGNAL_SCALE),
    Hist1D("vbs_jet2_pt", r"VBS Jet 2 $p_{T}$ [GeV]", (NUM_BINS, 0, 500), scale=SIGNAL_SCALE),
    Hist1D("vbs_jet2_eta", r"VBS Jet 2 $\eta$", (NUM_BINS, -5.0, 5.0), scale=SIGNAL_SCALE),
    Hist1D("vbs_jet2_phi", r"VBS Jet 2 $\phi$", (NUM_BINS, -3.5, 3.5), scale=SIGNAL_SCALE),
    Hist1D("vbs_mjj", r"VBS $m_{jj}$ [GeV]", (NUM_BINS, 0, 5000), scale=SIGNAL_SCALE),
...
def main():
    sig_files = [
        BASE_PATH + "1Lep2FJ_run3-sig_1lep_2FJ_r3_2fj_sig/*/*.root"
    ]
    bkg_files = [
         BASE_PATH + "1Lep2FJ_run3-bkg_1lep_2FJ_r3_2fj_bkg/*/*.root"
    ]
    data_files = [
        BASE_PATH + "1Lep2FJ_run3-data_1lep_2FJ_r3_2fj_data/*/*.root",
    ]
